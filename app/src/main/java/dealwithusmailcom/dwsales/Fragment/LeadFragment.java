...
import dealwithusmailcom.dwsales.Activity.NewLead;
...
public class LeadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.lead_fragment, container, false);
        // get the listview
        expListView = rootView.findViewById(R.id.idListView);
    ...
    private void MYlEAD() {
        ...
        dialog.show();
        StringRequest request = new StringRequest(StringRequest.Method.POST, APIUrls.leadList, new Response.Listener < String > () {
            @Override
            public void onResponse(String response) {
                ...
                try {
                   ...
                   Boolean aBoolean=object.getBoolean("status");
                    if (aBoolean) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            model.LeadLocation = Global.capitalizeFirstLetter(jsonObject.getString("location"));
                            model.LeadName = Global.capitalizeFirstLetter(jsonObject.getString("name"));
                            model.LeadMobile = jsonObject.getString("mobile");
                            model.Leademail = jsonObject.getString("email");
                            model.LeadRemark = Global.capitalizeFirstLetter(jsonObject.getString("remarks"));
                ...
                listAdapter = new ExpandableListAdapter(getContext(), listDataHeader , 1);
