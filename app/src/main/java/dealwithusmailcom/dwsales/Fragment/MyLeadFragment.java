...
public class MyLeadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.mylead_fragment, container, false);
        // get the listview
        expListView = rootView.findViewById(R.id.idrvmyLead);
    ...
    private void MYlEAD() {
        ...
        dialog.show();
        StringRequest request = new StringRequest(StringRequest.Method.POST, APIUrls.my_lead, new Response.Listener < String > () {
            @Override
